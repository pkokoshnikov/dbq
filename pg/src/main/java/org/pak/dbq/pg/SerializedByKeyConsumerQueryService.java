...
public final class SerializedByKeyConsumerQueryService implements ConsumerQueryService {
    ...
    public SerializedByKeyConsumerQueryService(
    ...
    public <T> List<MessageContainer<T>> selectMessages() throws DbqException {
        if (!pgQueryService.hasKeyLockTable(subscriptionId)) {
